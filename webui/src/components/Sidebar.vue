<script>
	export default {
		...
		watch: {
			// Osserva per i cambiamenti di userID
			userID(newUserID) {
		...
		methods: {
			...
			logoutButton() {
				...
				this.$emit('doLogoutMethod', false);
			}
		}
	};		
</script>
	...
	<div v-if="sidebarRoutes.includes(currentRoute)">
		<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
			<div class="position-sticky pt-4 sidebar-sticky">
				...
				<!-- Home button -->
				<li class="nav-item">
					<RouterLink to="/home" class="nav-link large-link"> 
				...
				<!-- Create button -->
				<li class="nav-item">
					<RouterLink to="/link1" class="nav-link large-link"> 
				...
				<!-- Profile button -->
				<li class="nav-item">
					<RouterLink :to="'/users/' + userID" class="nav-link large-link"> 
				...
				<!-- Logout button -->
				<li class="nav-item">
					<RouterLink to="/session" class="nav-link large-link" @click="logoutButton"> 
