	...
	<div v-if="sidebarRoutes.includes(currentRoute)">
		<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
			<div class="position-sticky pt-4 sidebar-sticky">
				...
				<!-- Home button -->
				<li class="nav-item" @click="navigateTo('/users/:username/stream')">
					<button class="nav-link large-link"> 
				...
				<!-- Create button -->
				<li class="nav-item" @click="navigateTo('/users/:username/photos')">
					<button class="nav-link large-link"> 
				...
				<!-- Profile button -->
				<li class="nav-item" @click="navigateTo('/users/:username')">
					<button class="nav-link large-link">
				...
				<!-- Logout button -->
				<li class="nav-item" @click="logoutButton">
					<button class="nav-link large-link"> 
